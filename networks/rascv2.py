...
from networks.components.rasc import RASC
import functools
...
class UnetSkipConnectionBlock(nn.Module):
    def __init__(self, outer_nc, inner_nc, input_nc=None,
                 ...
                 is_attention_layer=False, attention_model=RASC,
                 basicblock=MinimalUnetV2, outermostattention=False):
...
class UnetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, num_downs=8, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False,
                 is_attention_layer=False, attention_model=RASC, use_inner_attention=False, basicblock=MinimalUnetV2):
