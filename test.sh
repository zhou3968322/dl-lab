...
CUDA_VISIBLE_DEVICES=2,1 python train.py --config_file config/gan/medfe_with_inner_loss_mask_decoder.yaml --trainer_name medfe

CUDA_VISIBLE_DEVICES=9,8 python train.py --config_file config/gan/medfe_with_mask_decoder.yaml --trainer_name medfe

#dl2
CUDA_VISIBLE_DEVICES=6,4 python train.py --config_file config/gan/medfe_fake_mask_decoder.yaml --trainer_name medfe
